 ...
 */
public class EnrollmentResponse extends SecuredDataGenerator
{


    public EnrollmentResponse(CryptoHelper cryptoHelper, boolean isCompressed)
    {
        super(cryptoHelper);
    }
     ...
     * @param request the EtsiTs103097Data-Signed structure of the original request (see InnerEcResponse class and ETSI TS 102 941 for more information for more information), REQUIRED
     ...
     * @param request the part of the original request which will identify it in this response
    ...
    private EtsiTs103097Data createResponseSignedData(EtsiTs102941Data data, EtsiTs103097Certificate EAcertificate, PrivateKey EAprivateKey,  AlgorithmType signingAlgorithm) throws IOException, NoSuchAlgorithmException, SignatureException
    {
        ...
        return createSignedData(hashAlgorithm, data.getEncoded(), headerInfo, EAcertificate, EAprivateKey, signingAlgorithm);
    }
    ...
    private EtsiTs103097Data createRequestEncryptedData(EtsiTs103097Data data, SecretKey preSharedKey) throws IOException, GeneralSecurityException
    {
        ...
        RecipientInfo[] recipients = {getRecipientInfo(preSharedKey)};
