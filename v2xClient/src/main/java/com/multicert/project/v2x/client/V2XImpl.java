...
public class V2XImpl implements V2X {
	...
	{
		return ecRequestGenerator.generateEcRequest(itsID, canonicalKeys, vehicleAlgorithm, verificationKeys, vehicleAlgorithm, null, null, assuranceLevel, confidenceLevel, EnrollmentAuthorityCertificate);
	}
